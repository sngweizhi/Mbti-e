...
ttol = 'AgACAgUAAxkBAAIh12ERAeUcX2cI9JJUjsfLEzLHgwABagACQ60xG9fziFQduMk7tA2-4AEAAwIAA20AAyAE'
...
topics = {'Ni':{1:'What theories or concepts do you spend a lot of time thinking about?',2:'Have you laid out plans for the next 2,5 and 10 years? What are they? ',3:'What is one thing that gives you the most anxiety?',4:'How do you envision a perfect life?',5:'If money were no problem, what would you innovate?',6:'What do you predict will happen to the world in the next 5 years?'},\
    'Ne':{1:'Are you an entrepreneur or do you aspire to be one? What product or service will you sell?',2:'What is one recent technological innovation that gets you really excited?',3:'What are some projects you started but failed to finish?',4:'Do you have trouble sleeping at night because you think a lot?',5:"If you didn't have to work to make a living, how would you spend your time?",6:'What traits would make a perfect partner/friend?' },\
    ...
    'Fe':{1:'What world event are you most concerned about right now?',2:'When was the last time you volunteered? Did you enjoy it?',3:"'To take care of others, start by taking care of yourself.' Do you take care of yourself enough?",4:'Do you currently have a friend who you feel is toxic but you still spend time with?',5:'You see a friend who is depressed. Will you avoid talking to them and give them space or would you reach out to them and ask if they are ok?',6:'What kind of local club/group/classes would you love to join? Pottery, baking, skateboarding etc.' }}